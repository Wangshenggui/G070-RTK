...
//    //时间数据
//    OutGNRMCData[1] = GPRMC_Struct.Hour;
//    OutGNRMCData[2] = GPRMC_Struct.Min;
//    OutGNRMCData[3] = GPRMC_Struct.Sec;

//    //定位状态
//    OutGNRMCData[4] = GPRMC_Struct.LocationState;
...
//    }GPS_Speed;
//    
//    GPS_Speed.v = GPRMC_Struct.Speed;
//    //地面速度
//    OutGNRMCData[5]=GPS_Speed.bit[0];
//    OutGNRMCData[6]=GPS_Speed.bit[1];
//    OutGNRMCData[7]=GPS_Speed.bit[2];
//    OutGNRMCData[8]=GPS_Speed.bit[3];
//    

//    //航向角
//    OutGNRMCData[9] = GPRMC_Struct.CourseAngle;

//    //日期
//    OutGNRMCData[10] = GPRMC_Struct.Year;
//    OutGNRMCData[11] = GPRMC_Struct.Month;
//    OutGNRMCData[12] = GPRMC_Struct.Day;

//    //定位模式
//    OutGNRMCData[13] = GPRMC_Struct.ModeIndicator;
//    
//    union
//    {
//        double v;
...
//    //经度
//    GPS_Longitude.v=GPRMC_Struct.Longitude;
//    OutGNRMCData[14] = GPS_Longitude.bit[0];
//    OutGNRMCData[15] = GPS_Longitude.bit[1];
//    OutGNRMCData[16] = GPS_Longitude.bit[2];
//    OutGNRMCData[17] = GPS_Longitude.bit[3];
//    OutGNRMCData[18] = GPS_Longitude.bit[4];
//    OutGNRMCData[19] = GPS_Longitude.bit[5];
//    OutGNRMCData[20] = GPS_Longitude.bit[6];
//    OutGNRMCData[21] = GPS_Longitude.bit[7];
//    
//    union
//    {
//        double v;
...
//    //纬度
//    GPS_Latitude.v=GPRMC_Struct.Latitude;
//    OutGNRMCData[22] = GPS_Latitude.bit[0];
//    OutGNRMCData[23] = GPS_Latitude.bit[1];
//    OutGNRMCData[24] = GPS_Latitude.bit[2];
//    OutGNRMCData[25] = GPS_Latitude.bit[3];
//    OutGNRMCData[26] = GPS_Latitude.bit[4];
//    OutGNRMCData[27] = GPS_Latitude.bit[5];
//    OutGNRMCData[28] = GPS_Latitude.bit[6];
//    OutGNRMCData[29] = GPS_Latitude.bit[7];
//    

//    //帧尾巴
//    OutGNRMCData[30] = 0xeb;
//    OutGNRMCData[31] = 0x90;
}

//将数据复制到OutGNRMCData
//void BluetoothCopyRMCData()
//{
//    //帧头（一个字节）
//    OutGNRMCData[0] = 0xA5;
...
//    //定位状态（一个字节）
//    
//    switch(GPRMC_Struct.ModeIndicator)
//    {
//        case('A'):
//            OutGNRMCData[4] = 1;
//            break;
...
//            break;
//    }
////    OutGNRMCData[4] = GPRMC_Struct.ModeIndicator;
...
//        unsigned char bit[4];
//    }GPS_Speed;                                      
//    GPS_Speed.v = GPRMC_Struct.GroundSpeed * 0.5144*3.6;
//    //地面速度（4个字节float）
//    OutGNRMCData[5]=GPS_Speed.bit[0];
//    OutGNRMCData[6]=GPS_Speed.bit[1];
//    OutGNRMCData[7]=GPS_Speed.bit[2];
...
//        unsigned char bit[4];
//    }CourseAngle;
//    CourseAngle.v=GPRMC_Struct.CourseAngle;
//    //航向角（四个字节）
//    OutGNRMCData[9] = CourseAngle.bit[0];
//    OutGNRMCData[10] = CourseAngle.bit[1];
//    OutGNRMCData[11] = CourseAngle.bit[2];
//    OutGNRMCData[12] = CourseAngle.bit[3];
//    
//    union
//    {
//        float v;
...
//    }Longitude;
//    //经度
//    Longitude.v=GPRMC_Struct.Longitude;
//    OutGNRMCData[13] = Longitude.bit[0];
//    OutGNRMCData[14] = Longitude.bit[1];
//    OutGNRMCData[15] = Longitude.bit[2];
//    OutGNRMCData[16] = Longitude.bit[3];
//    
//    union
//    {
//        float v;
...
//    }Latitude;
//    //纬度
//    Latitude.v=GPRMC_Struct.Latitude;
//    OutGNRMCData[17] = Latitude.bit[0];
//    OutGNRMCData[18] = Latitude.bit[1];
//    OutGNRMCData[19] = Latitude.bit[2];
//    OutGNRMCData[20] = Latitude.bit[3];
//    
//    //速度(m/s)
//    GPS_Speed.v = GPRMC_Struct.GroundSpeed * 0.5144;
//    //地面速度（4个字节float）
//    OutGNRMCData[21]=GPS_Speed.bit[0];
//    OutGNRMCData[22]=GPS_Speed.bit[1];
//    OutGNRMCData[23]=GPS_Speed.bit[2];
//    OutGNRMCData[24]=GPS_Speed.bit[3];
//    
//    
//    
//    OutGNRMCData[25] = (OutGNRMCData[1]+OutGNRMCData[2]+OutGNRMCData[3]+OutGNRMCData[4]+OutGNRMCData[5]
//                        +OutGNRMCData[6]+OutGNRMCData[7]+OutGNRMCData[8]+OutGNRMCData[9]+OutGNRMCData[10]
//                        +OutGNRMCData[11]+OutGNRMCData[12]+OutGNRMCData[13]+OutGNRMCData[14]+OutGNRMCData[15]
//                        +OutGNRMCData[16]+OutGNRMCData[17]+OutGNRMCData[18]+OutGNRMCData[19]+OutGNRMCData[20]
//                        +OutGNRMCData[21]+OutGNRMCData[22]+OutGNRMCData[23]+OutGNRMCData[24])
//                        &0xff;
//    
//    OutGNRMCData[26] = 0x5A;
//    
//    
//    
